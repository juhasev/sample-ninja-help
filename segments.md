...
SampleNinja segments define sample populations with some established qualification i.e. Woman - Divorced - 30 to 40. By default, sample segments use the panel business rules defined in the panel settings, however if you turn on the segment as filter, business rules are no longer applied.
