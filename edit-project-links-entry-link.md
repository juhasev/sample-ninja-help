...
When you edit the configuration, you can specify what URL params names you want to use for the Panelist ID and Session ID. These will be automatically inserted at the end of the base URL.
```
