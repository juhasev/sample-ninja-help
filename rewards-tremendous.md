...
Unlike the other reward partners, **Sample Ninja sends the Tremendous reward emails from the email address your panelists are already familiar with**. Tremendous hands back a redemption link, and your panel emails it to the panelist, using an email template you control. See **The Reward Email** below. This gives you a fully white-labeled solution.
